...
Status: **Phase A in progress** — A0–A3 merged; A4 (gameplay sweep), A5
(save read-cap) and A6 (tests/shots/docs) in review. Remaining: the
one-line LOCAL_PLAYER_CAP flip PR once everything is verified.
