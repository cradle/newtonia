...
// FIELD RESULT (2026-09-05, Ubuntu snap Steam AND macOS Steam, Xbox
// Series X pad, A/B swapped in the app's own layout and the swap live in
// gameplay): GetActionOriginFromXboxOrigin(A) still answered XBoxOne_A on
// both. The call is a pad-type translation, not a layout lookup, so this
