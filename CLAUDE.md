...
Newtonia is a top-down 2D space shooter written in C++ using SDL2 and OpenGL. It supports single-player and local co-op (2 players today; the 4-player work is landing dark-launched — FOURPLAYER.md) and targets multiple platforms: desktop (macOS, Linux, Windows), mobile (iOS, Android), web (WebAssembly), Xbox/GDK, and Steam.
