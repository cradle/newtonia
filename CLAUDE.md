...
Two active GitHub Actions workflows drive the automatic PR/push checks — the self-hosted Xbox build and a GDKX-free hosted console-API compile smoke. Every other build/deploy workflow is disabled (moved into `.github/workflows/disabled/`).
