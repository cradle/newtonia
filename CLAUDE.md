...
**Savegame** (`savegame.h/cpp`) — binary format, magic "NWTN", version 22 (v22 carries no field changes — it gates the appended `Hazard::Kind` HUNTER value out of pre-hunter builds):
